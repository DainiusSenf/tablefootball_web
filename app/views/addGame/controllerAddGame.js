...
.controller('AddGameCTRL', function ($scope, $rootScope, $http) {
	...
	function updatePlayerStatistic(player, elo) {
		...
		$http.get("app/services/getPlayerStatistic.php?player=" + player).success(function(data){
			...
			if(data.length > 0){
				...
				$query = "app/services/updatePlayerStatistic.php?player=" + player +
				...
				$query = "app/services/createPlayerStatistic.php?player=" + player +
	...
	function updatePlayerElo(player, elo) {
		console.log(elo);
		$query = "app/services/updatePlayerElo.php?player=" + player + "&elo=" + elo;
		$http.post($query).success(function (data) {
			console.log(data);
		});
	}
	...
	function getPlayers() {
		$query = "app/services/getPlayersElo.php?player1=" + $scope.player1 + "&player2=" + $scope.player2 + "&player3=" + $scope.player3
		...
		$http.post($query).success(function (data) {
			...
			$query = "app/services/addGame.php?player1=" + $scope.player1 + "&player2=" + $scope.player2 + "&player3=" + $scope.player3
			 + "&player4=" + $scope.player4 + "&score1=" + $scope.score1 + "&score2=" + $scope.score2+ "&player1eloChange=" + player1eloChange+
			 "&player2eloChange=" + player2eloChange+ "&player3eloChange=" + player3eloChange+ "&player4eloChange=" + player4eloChange;
			$http.post($query).success(function (data) {
				alert("Games saved");
				console.log(data);
				console.log(player1eloChange);
